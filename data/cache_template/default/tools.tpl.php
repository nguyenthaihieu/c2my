...
<?php } ?>
    ...
    <div class="foot_h">
        <p>
            <a href="<?php echo url("about.php?action=aboutus"); ?>">关于代购</a>&nbsp;|&nbsp;<a href="<?php echo url("about.php?action=links"); ?>">联系我们</a>&nbsp;|&nbsp;<a href="<?php echo url("about.php?action=joinus"); ?>">加入我们</a>&nbsp;|&nbsp;<a href="<?php echo url("about.php?action=links"); ?>" target="_blank">团队博客</a>&nbsp;|&nbsp;<a href="<?php echo url("about.php?action=links"); ?>">友情链接</a>
        </p>
